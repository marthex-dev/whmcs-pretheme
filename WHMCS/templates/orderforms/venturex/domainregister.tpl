    ...
    <div class="top">
      <div class="container">
        <div>
          ...
          <h1 class="wow fadeInDown">Alan Adı Tescil</h1>
      ...
      <div>
        ...
        <div class="form">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="32" height="32" viewBox="0 0 32 32">
            <g data-name="Mask Group 4" transform="translate(-0.33)">
              <g data-name="Layer 2">
                <g >
                  <rect data-name="Rectangle 980" width="32" height="32" transform="translate(0.33)" fill="#7988a3" opacity="0"/>
                  <path data-name="Path 1971" d="M27.613,25.72,23.08,21.2a10.56,10.56,0,0,0,2.253-6.533A10.667,10.667,0,1,0,14.667,25.333,10.56,10.56,0,0,0,21.2,23.08l4.52,4.533a1.339,1.339,0,1,0,1.893-1.893ZM6.667,14.667a8,8,0,1,1,8,8,8,8,0,0,1-8-8Z" fill="#7988a3"/>
                </g>
              </g>
            </g>
          </svg>
          <input type="text" name="domain" placeholder="{$LANG.findyourdomain}" value="{$lookupTerm}" id="inputDomain" data-toggle="tooltip" data-placement="left" data-trigger="manual" title="{lang key='orderForm.domainOrKeyword'}" />
          <button type="submit" id="btnCheckAvailability" class="domain-check-availability{$captcha->getButtonClass($captchaForm)}">{$LANG.search}</button>
        </div>
      </form>
      </div>
    </div>
...
<div class="container">
    ...
    <div class="domainName">
      <div class="container">
          ...
          <table>
            <thead>
              <tr>
                <th>TLD</th>
                <th>Kayıt Ücreti</th>
                <th>Transfer Ücreti</th>
                <th>Yenileme/Uzatma</th>
              </tr>
            </thead>
            <tbody>
              ...
              {foreach $pricing['pricing'] as $tld => $price}
          	        <tr>
                      <td data-head="TLD">.{$tld}</td>
          			{if current($price.register) >= 0}
                    <td data-head="Kayıt Ücreti">{current($price.register)}</td>
          			{else}
          			    <td data-head="Kayıt Ücreti">N/A</td>
          			{/if}
          	        {if current($price.transfer) > 0}
                        <td data-head="Transfer Ücreti">>{current($price.transfer)}</td>
          	        {else}
                        <td data-head="Transfer Ücreti">N/A</td>
          	        {/if}
          	        {if current($price.renew) > 0}
                        <td data-head="Yenileme/Uzatma">{current($price.renew)}</td>
          	        {else}
                    <td data-head="Yenileme/Uzatma">N/A</td>
          	        {/if}
                  </tr>
          		{/foreach}
        ...
        <img src="templates/{$template}/assets/images/domainName2.png" alt="domainName2">
      </div>
    </div>
      ...
      <div>
        <div>
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="39" height="39" viewBox="0 0 39 39">
            <g data-name="Mask Group 230" transform="translate(-585 -3410)">
              <path d="M40.3,6.933H13.433a.869.869,0,0,0-.867.867v4.333H8.233A.869.869,0,0,0,7.367,13v4.333H3.033a.869.869,0,0,0-.867.867V35.533a.869.869,0,0,0,.867.867H29.9a.869.869,0,0,0,.867-.867V31.2H35.1a.869.869,0,0,0,.867-.867V26H40.3a.869.869,0,0,0,.867-.867V7.8A.869.869,0,0,0,40.3,6.933ZM29.033,34.667H3.9v-15.6H7.367V30.333a.869.869,0,0,0,.867.867h20.8Zm5.2-6.686-.048-.013a.887.887,0,0,0-.338,0,.718.718,0,0,0-.165.048.982.982,0,0,0-.147.082.935.935,0,0,0-.238.238.708.708,0,0,0-.082.147.718.718,0,0,0-.048.165.746.746,0,0,0
,0,0-.048.165.746.746,0,0,0-.017.169.852.852,0,0,0,.256.611.814.814,0,0,0,.277.191.88.88,0,0,0,.334.065.864.864,0,0,0,.611-1.478A.208.208,0,0,0,27.647,26h3.64a.209.209,0,0,0-.048.039.852.852,0,0,0-.256.611.88.88,0,0,0,.065.334.924.924,0,0,0,.468.468.88.88,0,0,0,.334.065.859.859,0,0,0,.611-.256.814.814,0,0,0,.191-.277.88.88,0,0,0,.065-.334.852.852,0,0,0-.256-.611c-.013-.017-.035-.026-.048-.039h1.82Zm5.2-3.714H14.3V8.667H39.433Z" transform="translate(582.833 3407.833)" fill="#ff5f8d"/>
            </g>
          </svg>
          <h4>.TR Uzantı İçin Gerekli Belgeler</h4>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer cursus enim viverra, sollicitudin ligula a, viverra purus.</p>
        </div>
        <ul class="accortion">
          <li>
            <strong><span>1</span>.com.tr Alan Adı İçin İstenen Belgeler</strong>
            <div>
              <p>Alan adının tahsisi için, alan adı sahibi resmi/devlet kuruluşun en üst makamı tarafından verilen antetli kağıt üzerinde, imzalı, kaşeli varsa mühürlü talebin, alan adı tahsis belgesiyle birlikte iletilmesi halinde başvurular tescil edilebilir.</p>
            </div>
          </li>
          <li>
            <strong><span>2</span>.org.tr Alan Adı İçin İstenen Belgeler</strong>
            <div>
              <p>Alan adının tahsisi için, alan adı sahibi resmi/devlet kuruluşun en üst makamı tarafından verilen antetli kağıt üzerinde, imzalı, kaşeli varsa mühürlü talebin, alan adı tahsis belgesiyle birlikte iletilmesi halinde başvurular tescil edilebilir.</p>
            </div>
          </li>
          <li class="open">
            <strong><span>3</span>.gov.tr Alan Adı İçin İstenen Belgeler</strong>
            <div>
              <p>Alan adının tahsisi için, alan adı sahibi resmi/devlet kuruluşun en üst makamı tarafından verilen antetli kağıt üzerinde, imzalı, kaşeli varsa mühürlü talebin, alan adı tahsis belgesiyle birlikte iletilmesi halinde başvurular tescil edilebilir.</p>
            </div>
          </li>
          <li>
            <strong><span>4</span>.bel.tr Alan Adı İçin İstenen Belgeler</strong>
            <div>
              <p>Alan adının tahsisi için, alan adı sahibi resmi/devlet kuruluşun en üst makamı tarafından verilen antetli kağıt üzerinde, imzalı, kaşeli varsa mühürlü talebin, alan adı tahsis belgesiyle birlikte iletilmesi halinde başvurular tescil edilebilir.</p>
            </div>
          </li>
          <li>
            <strong><span>5</span>.k12.tr Alan Adı İçin İstenen Belgeler</strong>
            <div>
              <p>Alan adının tahsisi için, alan adı sahibi resmi/devlet kuruluşun en üst makamı tarafından verilen antetli kağıt üzerinde, imzalı, kaşeli varsa mühürlü talebin, alan adı tahsis belgesiyle birlikte iletilmesi halinde başvurular tescil edilebilir.</p>
            </div>
          </li>
          <li>
            <strong><span>6</span>.net.tr Alan Adı İçin İstenen Belgeler</strong>
            <div>
              <p>Alan adının tahsisi için, alan adı sahibi resmi/devlet kuruluşun en üst makamı tarafından verilen antetli kağıt üzerinde, imzalı, kaşeli varsa mühürlü talebin, alan adı tahsis belgesiyle birlikte iletilmesi halinde başvurular tescil edilebilir.</p>
            </div>
          </li>
