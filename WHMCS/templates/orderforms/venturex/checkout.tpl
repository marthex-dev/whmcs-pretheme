...
{include file="orderforms/venturex/common.tpl"}
...
<div id="order-standard_cart">
    ...
    <div class="row">
        ...
        <div class="col-md-3 pull-md-left sidebar hidden-xs hidden-sm">
            ...
            {include file="orderforms/venturex/sidebar-categories.tpl"}

        </div>

        <div class="col-md-9 pull-md-right">

            {include file="orderforms/venturex/sidebar-categories-collapsed.tpl"}
            ...
            <form method="post" action="{$smarty.server.PHP_SELF}?a=checkout" name="orderfrm" id="frmCheckout">
                ...
                <div id="containerExistingUserSignin"{if $loggedin || $custtype neq "existing"} class="hidden"{/if}>
                    ...
                    {include file="orderforms/venturex/linkedaccounts.tpl" linkContext="checkout-existing"}
                </div>

                <div id="containerNewUserSignup"{if $custtype eq "existing" AND !$loggedin} class="hidden"{/if}>

                    <div{if $loggedin} class="hidden"{/if}>
                        {include file="orderforms/venturex/linkedaccounts.tpl" linkContext="checkout-new"}
                    </div>
